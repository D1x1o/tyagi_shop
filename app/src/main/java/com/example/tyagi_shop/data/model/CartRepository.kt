...
import com.example.tyagi_shop.data.model.AddToCartRequest
import com.example.tyagi_shop.data.model.UpdateCartRequest
...
class CartRepository {
    ...
    suspend fun getCart(userId: String, token: String): List<Cart>? {
        return try {
            ...
            val response = service.getCart(filter)
    ...
    suspend fun addToCart(userId: String, productId: String, token: String): Cart? {
        return try {
            ...
            val response = service.addToCart(request)
